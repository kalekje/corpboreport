...
\date{\today}
\logo{\includegraphics[width=3cm,smash=tl]{images/uds.pdf}}
...
\begin{frame}
		\includegraphics[width=\linewidth]{images/uds.pdf}
...
%\FitToHeight{\includegraphics[rotate=90,\HeightMax]{images/uds.pdf}}
%\end{frame}
...
\end{frame}
	...
	\begin{frame}{\ }
		\begin{tabular}{lcl}\toprule
			\tmrkr[t]{2a}a & \tmrkr[t]{1a}b2 & c\tmrkr[b]{2b}\\\midrule
			\tmrkr[m]{3}1 & 2222 & 3\\\midrule
			x & y & z\tmrkr[b]{1b}\\\bottomrule
		\end{tabular}
...
\begin{frame}{\ }
	...
	\begColNW
		\begin{itemize}
			...
			\item<alert@\fpeval{\imgnumX-1}-\fpeval{\imgnumX}|\fpeval{\imgnumX-1}->  Here's the starting point:\tmrkr*[m]{p1}
		\end{itemize}
		*(the author is not liable for seizures due to excitement)
	\nextCol
%		\drawHelpingGrid%
		\tmrkr*(0.75,1.2){p2}\includegraphics<\imgnumX->{C:/Users/Kale/Projects/pltx/testing/dum-crop.pdf}
%		\tmrkr(0,0){p}\includegraphics{C:/Users/Kale/Projects/pltx/testing/dum-crop.pdf}
		\freecaption<|\imgnumX->{Hello world.}
	\endCol
	\tikz[OLB,nopad,visible on=<\fpeval{\imgnumX+2}->] \draw[ultra thick,pink,->] (tm-p1) to[bend left] (tm-p2);
...
%			\end{AutoPuncItems}
		...
		Apple & 3 & PinkLady\atnote{oi} \\
		\bottomrule
		\end{tabular}
		\freecaption{\atfnote{oi}The quick brown fox.}
